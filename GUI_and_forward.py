...
class NNApp:
    ...
    def train_network(self):
        file_path = "C:\\Users\\Ahmed Raafat\\Documents\\birds.csv"
        # Preprocess the data
        ...
        if inputs:
            ...
            D = preprocessed_df['bird category'].values  
            NN = NeuralNetwork(
            ...
            for epoch in range(epochs):
                output = NN.forward(X)  # Forward pass using the NN instance
                NN.target = D  # Set target for the update_weights method
                NN.feed_forward_2(X)  # Update weights in the second pass
            self.train_status_output.config(text="Training Completed!", fg="green")
    ...
    def test_network(self):
        ...
        # Use the correct instance of NeuralNetwork to perform forward pass
        predictions = NN.forward(X)  # Forward pass using the NN instance
